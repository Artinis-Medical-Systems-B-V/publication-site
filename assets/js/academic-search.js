...
// Modify the existing search function
function search(query) {
  ...
  // Apply category filter after the initial search
  if (categoryFilter) {
...
if (categorySelect) {
  categorySelect.addEventListener('change', function() {
    ...
    // Perform search with both query and category
    search(searchQuery);
  });
}

// Modify existing search input listener
